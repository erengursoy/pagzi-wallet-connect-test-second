<template>
  <div>
    ...
    <div class="connet-wallet bronto flex justify-center  xl:pr-10 lg:pr-5 pr-1 text-center" v-else-if="walletConnection.connectionStatus !== 'falseNetwork' && walletConnection.address !== null">
      <button type="button" class="xl:text-2xl lg:text-xl xs:text-base text-sm">Connected Wallet</button>
    ...
    <div v-else class=" flex justify-center">
      <button type="button" class="inline-block p-7 border-1 border-blue-800 bg-gray-100">Connect Wallet</button>
